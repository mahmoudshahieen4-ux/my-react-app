...
import soloImg from "../assets/images/Gemini_Generated_Image_ad6wirad6wirad6w.png";
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col md:flex-row-reverse items-center justify-center min-h-screen gap-6 md:gap-10 px-6 sm:px-10 lg:px-16 xl:px-24 pt-24 pb-16">
                ...
                <div className="shrink-0 flex items-center justify-center relative md:w-[44%] lg:w-[46%] xl:w-[48%]">
                    ...
                    <div
                        className="glitch-wrapper relative select-none object-cover px-5 py-10"
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left gap-4 flex-1 max-w-[560px]">
                    ...
                    <div
                        aria-hidden
                        className="w-[55%] h-px bg-linear-to-r from-transparent via-purple-500/55 to-transparent opacity-0 animate-fade-in-up [animation-delay:0.6s] [animation-fill-mode:forwards]"
                    />
